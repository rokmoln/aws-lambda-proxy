"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.run = exports.mainMaster = exports.onSimpleEvent = exports.mainWorker = exports.onHeartbeat = exports.onUncaughtException = exports.maybeWriteHeapSnapshot = exports.writeHeapSnapshot = exports.httpServer = exports.workerId = exports.heapdump = void 0;var _lodashFirecloud = _interopRequireDefault(require("lodash-firecloud"));
...
let onUncaughtException = function (err) {
  ...
  try {
    ...
    _log.default.fatal(exceptionLog, 'Uncaught exception');
  } catch (e) {
    console.error(e);
  }
  ...
  if (_cluster.default.isMaster || !exports.httpServer) {
    ...
    setTimeout(function () {
      _log.default.error('HTTP server is stalling upon closing down. Forcefully terminating.');
      // eslint-disable-next-line no-process-exit
      process.exit(1);
    });
  }
...
let onHeartbeat = function () {
  return function () {
    ...
    _log.default[level](heartbeatLog, 'Heartbeat');
  };
}();
...
let mainWorker = async function () {
  ...
  let lambdas = await (async createError => {try {return await _env.default.hooks.findLambdas({ env: _env.default });} catch (_awaitTraceErr) {let err = createError();_awaitTraceErr.stack += "\n...\n" + err.stack;throw _awaitTraceErr;}})(() => new Error());
  ...
  await (async createError => {try {return await _expressApp.default.loadLambdas({ app, lambdas });} catch (_awaitTraceErr2) {let err = createError();_awaitTraceErr2.stack += "\n...\n" + err.stack;throw _awaitTraceErr2;}})(() => new Error());
...
let mainMaster = function () {
  ...
  _log.default.trace(startupLog, 'Starting');
